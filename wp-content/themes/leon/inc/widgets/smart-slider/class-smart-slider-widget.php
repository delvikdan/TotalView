...
if ( ! class_exists( 'Leon_Smart_Slider_Widget' ) ) {

	class Leon_Smart_Slider_Widget extends Cherry_Abstract_Widget {
		...
		public function __construct() {
			...
			$this->widget_description	= esc_html__( 'Display smart slider on your site.', 'leon' );
			$this->widget_id			= 'leon_widget_smart_slider';
			$this->widget_name			= esc_html__( 'Smart Slider', 'leon' );
			...
			$this->settings 			= array(
				...
				'posts_per_page' => array(
					...
					'max_value'			=> 50,
					'min_value'			=> 1,
					'label'				=> esc_html__( 'Posts count', 'leon' ),
				),
				'post_title' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display title', 'leon' ),
				),
				'content' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display content', 'leon' ),
				),
				'more_button' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display more button', 'leon' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'leon' ),
						'false_toggle'	=> esc_html__( 'Off', 'leon' ),
				...
				'more_button_text' => array(
					'type'				=> 'text',
					'value'				=> esc_html__( 'Read more', 'leon' ),
					'label'				=> esc_html__( 'More button text', 'leon' ),
				...
				'trim_words' => array(
					...
					'min_value'			=> 1,
					'step_value'		=> 1,
					'label'				=> esc_html__( 'Content words trimmed count', 'leon' ),
				),
				'width' => array(
					'type'				=> 'text',
					'value'				=> '100%',
					'label'				=> esc_html__( 'Slider width', 'leon' ),
				),
				'height' => array(
					'type'				=> 'text',
					'value'				=> '800',
					'label'				=> esc_html__( 'Slider height', 'leon' ),
				),
				'orientation' => array(
					'type'				=> 'select',
					'size'				=> 1,
					'value'				=> 'horizontal',
					'options' => array(
						'horizontal'	=> esc_html__( 'Horizontal', 'leon' ),
						'vertical'		=> esc_html__( 'Vertical', 'leon' ),
					),
					'label'				=> esc_html__( 'Slider orientation', 'leon' ),
				),
				'slide_distance' => array(
					...
					'max_value'			=> 100,
					'min_value'			=> 0,
					'label'				=> esc_html__( 'Slide distance(px)', 'leon' ),
				),
				'slide_duration' => array(
					...
					'min_value'			=> 100,
					'step_value'		=> 100,
					'label'				=> esc_html__( 'Slide duration(ms)', 'leon' ),
				),
				'slide_fade' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use fade effect?', 'leon' ),
				),
				'navigation' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use navigation?', 'leon' ),
					'toggle' => array(
						'true_toggle'	=> esc_html__( 'On', 'leon' ),
						'false_toggle'	=> esc_html__( 'Off', 'leon' ),
				...
				'fade_navigation' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates whether the arrows will fade in only on hover', 'leon' ),
				...
				'pagination' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use pagination?', 'leon' ),
				),
				'autoplay' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use autoplay?', 'leon' ),
				),
				'fullScreen' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display fullScreen button?', 'leon' ),
				),
				'shuffle' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Indicates if the slides will be shuffled', 'leon' ),
				),
				'loop' => array(
					'type'				=> 'switcher',
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Use infinite scrolling?', 'leon' ),
				),
				'thumbnails' => array(
					'type'				=> 'switcher',
					'value'				=> 'false',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails?', 'leon' ),
					'toggle'			=> array(
						'true_toggle'	=> esc_html__( 'On', 'leon' ),
						'false_toggle'	=> esc_html__( 'Off', 'leon' ),
				...
				'thumbnails_position' => array(
					...
					'options' => array(
						...
						'bottom'		=> esc_html__( 'Bottom', 'leon' ),
						'right'			=> esc_html__( 'Right', 'leon' ),
						'left'			=> esc_html__( 'Left', 'leon' ),
					),
					'label'				=> esc_html__( 'Sets the position of the thumbnail scroller', 'leon' ),
				...
				'thumbnails_arrows' => array(
					...
					'value'				=> 'true',
					'style'				=> ( wp_is_mobile() ) ? 'normal' : 'small',
					'label'				=> esc_html__( 'Display thumbnails arrows?', 'leon' ),
					'master'			=> 'thumbnails_attr',
				),
			);
		...
		public function widget( $args, $instance ) {
			...
			if ( $posts_query ) {
				...
				$html = '<h4>' . esc_html__( 'Posts for slider not found', 'leon' ) . '</h4>';
			}
		...
		public function render_slider( $posts_query ) {
			...
			$html = '<div class="leon-smartslider smart-slider__instance invert" ' . $slider_html_attr . '>';
		...
		public function get_query_slider_items( $query_args = array() ) {
			...
			$defaults_query_args = apply_filters( 'leon_smart_slider_default_query_args', array(
				'post_type'				=> 'post',
				'orderby'				=> 'date',
				'order'					=> 'DESC',
				'posts_per_page'		=> -1,
		...
		public function get_slider_loop( $posts_query ) {
			 ...
			 * @var  array
			 */
			$title_settings = apply_filters( 'leon_smart_slider_title_settings', array(
				'width'				=> '100%%',
				'horizontal'		=> '0%%',
				'vertical'			=> '38%%',
			 ...
			 * @var  array
			 */
			$content_settings = apply_filters( 'leon_smart_slider_content_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '51%%',
				'show_transition'	=> 'left',
			 ...
			 * @var  array
			 */
			$more_settings = apply_filters( 'leon_smart_slider_more_button_settings', array(
				'width'				=> '90%%',
				'horizontal'		=> '5%%',
				'vertical'			=> '58%%',
				'show_transition'	=> 'left',
	...
	add_action( 'widgets_init', 'leon_register_smart_slider_widgets' );
	function leon_register_smart_slider_widgets() {
		register_widget( 'Leon_Smart_Slider_Widget' );
	}
}