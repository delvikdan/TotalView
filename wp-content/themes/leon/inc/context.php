...
function leon_utility() {
	return leon_theme()->get_core()->modules['cherry-utility'];
}
 ...
 * @return void
 */
function leon_header_class( $classes = array() ) {
	$classes[] = 'site-header';
	$classes[] = get_theme_mod( 'header_layout_type' );
	echo leon_get_container_classes( $classes, 'header' );
}
 ...
 * @return void
 */
function leon_content_class( $classes = array() ) {
	$classes[] = 'site-content';
	echo leon_get_container_classes( $classes, 'content' );
}
 ...
 * @return void
 */
function leon_footer_class( $classes = array() ) {
	$classes[] = 'site-footer';
	$classes[] = get_theme_mod( 'footer_layout_type' );
	echo leon_get_container_classes( $classes, 'footer' );
}
 ...
 * @return string
 */
 function leon_get_container_classes( $classes, $target = 'content' ) {
  switch ( $target ) {
  	case 'header':
 ...
 * @return void
 */
function leon_primary_content_class( $classes = array() ) {
	echo leon_get_layout_classes( 'content', $classes );
}
 ...
 * @return void
 */
function leon_sidebar_class( $classes = array() ) {
	echo leon_get_layout_classes( 'sidebar', $classes );
}
 ...
 * @return string
 */
function leon_get_layout_classes( $layout = 'content', $classes = array() ) {
	...
	$layout_classes = ! empty( leon_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] ) ? leon_theme()->layout[ $sidebar_position ][ $sidebar_width ][ $layout ] : array();
	...
	$layout_classes = apply_filters( "leon_{$layout}_classes", $layout_classes );
 ...
 * @return string|void
 */
function leon_posts_list_class( $classes = array(), $echo = true ) {
	$layout_type      = get_theme_mod( 'blog_layout_type', leon_theme()->customizer->get_default( 'blog_layout_type' ) );
	$layout_type      = ! is_search() ? $layout_type : 'default';
	$sidebar_position = get_theme_mod( 'sidebar_position', leon_theme()->customizer->get_default( 'sidebar_position' ) );
	...
	foreach ( $sidebars as $sidebar ) {
		if ( leon_widget_area()->is_active_sidebar( $sidebar ) ) {
			$has_sidebars = true;
		}
	}
	...
	$classes = apply_filters( 'leon_posts_list_class', $classes );
