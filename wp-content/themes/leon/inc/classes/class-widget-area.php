...
if ( ! class_exists( 'Leon_Widget_Area' ) ) {

	class Leon_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'leon_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'leon_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'leon_widget_area_classes', $classes, $area_id );
	...
	function leon_widget_area() {
		return Leon_Widget_Area::get_instance();
	}
