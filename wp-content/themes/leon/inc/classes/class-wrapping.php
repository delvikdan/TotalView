 ...
 */
add_filter( 'template_include', array( 'Leon_Wrapping', 'wrap' ), 99 );
add_filter( 'leon_wrap_base', 'leon_wrap_base_cpts' );
 ...
 */
function leon_template_path() {
	return Leon_Wrapping::$main_template;
}
 ...
 */
function leon_template_base() {
	return Leon_Wrapping::$base;
}

if ( ! class_exists( 'Leon_Wrapping' ) ) {
	...
	class Leon_Wrapping {
		...
		/**
		 * Initialize new instance of Leon_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'leon_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Leon_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function leon_wrap_base_cpts( $templates ) {
