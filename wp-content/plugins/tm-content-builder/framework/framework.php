...
function tm_builder_load_modules_styles() {
	...
	wp_localize_script( 'tm-builder-modules-script', 'tm_pb_custom', array(
		...
		'subscription_failed'    => esc_html__( 'Пожалуйста, проверьте поля и убедитесь в корректности введенной информации', 'tm_builder' ),
		'fill_message'           => esc_html__( 'Пожалуйста, заполните следующие поля:', 'tm_builder' ),
		'contact_error_message'  => esc_html__( 'Пожалуйста, исправьте ошибки:', 'tm_builder' ),
		'invalid'                => esc_html__( 'Некорректный email', 'tm_builder' ),
		'captcha'                => esc_html__( 'Captcha', 'tm_builder' ),
		'prev'                   => esc_html__( 'Prev', 'tm_builder' ),
		'previous'               => esc_html__( 'Назад', 'tm_builder' ),
		'next'                   => esc_html__( 'Далее', 'tm_builder' ),
		'wrong_captcha'          => esc_html__( 'Вы ввели неправильный код', 'tm_builder' ),
